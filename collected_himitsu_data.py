...
def mk_x_train(all_word_list, word_vec, collected):
	...
	for item in collected:
		x_data = x_data.append(word_vec[item])
...
if __name__ == "__main__":
	...
	x_train = mk_x_train(all_word_list, word_vec, collected)
	y_train = mk_y_train(all_word_list, collected)
